...
async function showVerificationTasks(ctx) {
  await ctx.replyWithHTML(
    ...
    `🐥 <a href="https://x.com/Airdropmanaging">Follow Our X Profile</a>\n\n` +
    ...
    Markup.inlineKeyboard([
      ...
      [
        Markup.button.url('💬 Join Second Channel', 'https://t.me/airdropunknow'),
        Markup.button.callback('✅ Verify', 'verify_channel_2')
      ],
      [
        Markup.button.url('🐥 Follow Twitter', 'https://t.me/airdropmanaging'),
